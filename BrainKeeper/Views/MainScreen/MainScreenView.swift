...
struct MainScreenView: View {
    ...
    var body: some View {
        ...
        ZStack{
            let testsFinish = viewModel.day == showFinishCoverDay && vm.showFinishCover
            let testsNotFinish = !viewModel.isWordsTestFinish && !viewModel.isStroopTestFinish
            ...
            VStack  {
                let firstDay = viewModel.day == 1 && testsNotFinish
                ...
                TestResultsView()
                    .frame(height: screenSize.height *  (viewModel.day == 1 && testsNotFinish ? 0.30 : 0.38))
                    .padding(.bottom)
...
extension MainScreenView{
    ...
    private var testsCards: some View{

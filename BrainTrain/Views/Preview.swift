...
let tutotialCards: [Tutorial] = [
    ...
    Tutorial(id: 1, lottie: "tutorial1", headline: "", text: "Выполняйте упражнения каждую неделю с понедельника по пятницу, а в субботу проверяйте работу лобных долей мозга.")
]

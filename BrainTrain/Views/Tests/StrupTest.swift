                    ...
                    VStack (spacing: 10){
                      ...
                      Spacer()
                        ...
                        Button(action: {
                            ...
                            Text(viewModel.isStrupTestFinish  ? "Пройти еще раз" : "Старт")
                                .mainFont(size: 20)

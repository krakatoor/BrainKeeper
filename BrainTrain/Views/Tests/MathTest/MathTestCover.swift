    ...
    var body: some View {
        VStack (spacing: 10){
            Text("Отлично!")
                .font(.title2)
                .bold()
            Text("Мы зафиксировали отправную точку.\nВ последующие 5 дней вы будете решать простые математические примеры на сложение, вычитание, умножение  и деления. Как показали исследования решение подобных примеров один из лучших тренажеров мозга. Решение примеров на время снижает процесс старения мозга. У всех испытыемых отмечено улучшение памяти: у взрослых после месяца тренировки память улучшается на 12%, а у детей на 20%.\n\nЗапомните - вы соревнуетесь с собой. Сверяйте результаты разных недель. Улучшайте их. У вас все получится!")
